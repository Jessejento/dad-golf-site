        ...
        <div className="max-w-7xl mx-auto px-4 py-8">
            ...
            <div className="flex justify-between items-center mb-8">
                ...
                <div className="flex items-center space-x-4">
                    ...
                    <button
                        onClick={() => window.location.href = 'https://jentoooosgolf.sanity.studio/desk/event'}
                        ...
                        <div key={event._id} className="bg-white rounded-lg shadow-lg overflow-hidden">
                            ...
                            <div className="p-6">
                                <div className="flex justify-between items-start">
                                    ...
                                    <span className={`px-2 py-1 text-sm rounded-full ${getStatusColor(event.status)}`}>
                                ...
                                <div className="mt-4 space-y-3">
                                    <div className="flex items-center text-gray-600">
                                        ...
                                        <div>
                                            <div>{format(new Date(event.startDate), 'MMM d, yyyy h:mm a')}</div>
                                            <div>to {format(new Date(event.endDate), 'MMM d, yyyy h:mm a')}</div>
                                        </div>
                                    </div>
